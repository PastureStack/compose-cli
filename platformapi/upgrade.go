...
func (r *PlatformService) upgrade(service *client.Service, force bool, selected []string) (*client.Service, error) {
...
func (r *PlatformService) rollback(service *client.Service) (*client.Service, error) {
	factory, err := GetFactory(r)
	if err != nil {
		return nil, err
	}
...
func (r *PlatformService) shouldUpgrade(service *client.Service) bool {
...
func (r *PlatformService) isOutOfSync(service *client.Service) bool {
	if service == nil {
		return false
	}
