...
type PlatformVolumesFactory struct {
	Context *Context
}

func (f *PlatformVolumesFactory) Create(projectName string, volumeConfigs map[string]*config.VolumeConfig, serviceConfigs *config.ServiceConfigs) (project.Volumes, error) {
