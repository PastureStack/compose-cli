...
// Question and CatalogConfig are the small rancher-compose.yml catalog
// contract used by this CLI. They replace an abandoned catalog-service model
// dependency without changing the accepted YAML shape.
